...
int main()
{
    auto D01P1 = AoC2015::Day01::A(AoC::Helpers::ReadToken<std::string>("./Day01.txt"));
    std::cout << "Day 01 - A (" << std::format("{:10.4f}", D01P1.second.count()) << "ms): " << D01P1.first << "\n";
    auto D01P2 = AoC2015::Day01::B(AoC::Helpers::ReadToken<std::string>("./Day01.txt"));
    std::cout << "Day 01 - B (" << std::format("{:10.4f}", D01P2.second.count()) << "ms): " << D01P2.first << "\n";

    auto D02P1 = AoC2015::Day02::A(AoC::Helpers::ReadTokens<std::string>("./Day02.txt"));
    std::cout << "Day 02 - A (" << std::format("{:10.4f}", D02P1.second.count()) << "ms): " << D02P1.first << "\n";
    auto D02P2 = AoC2015::Day02::B(AoC::Helpers::ReadTokens<std::string>("./Day02.txt"));
    std::cout << "Day 02 - B (" << std::format("{:10.4f}", D02P2.second.count()) << "ms): " << D02P2.first << "\n";

    auto D03P1 = AoC2015::Day03::A(AoC::Helpers::ReadToken<std::string>("./Day03.txt"));
    std::cout << "Day 03 - A (" << std::format("{:10.4f}", D03P1.second.count()) << "ms): " << D03P1.first << "\n";
    auto D03P2 = AoC2015::Day03::B(AoC::Helpers::ReadToken<std::string>("./Day03.txt"));
    std::cout << "Day 03 - B (" << std::format("{:10.4f}", D03P2.second.count()) << "ms): " << D03P2.first << "\n";

    auto D04P1 = AoC2015::Day04::A(AoC::Helpers::ReadToken<std::string>("./Day04.txt"));
