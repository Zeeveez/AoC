...
int main()
{
    ...
    auto D17P1 = AoC2022::Day17::A(AoC::Helpers::ReadLines("./Day17.txt"));
    std::cout << "Day 17 - A (" << std::format("{:10.4f}", D17P1.second.count()) << "ms): " << D17P1.first << "\n";
    auto D17P2 = AoC2022::Day17::B(AoC::Helpers::ReadLines("./Day17.txt"));
    ...
    auto D20P1 = AoC2022::Day20::A(AoC::Helpers::ReadLines("./Day20.txt"));
    std::cout << "Day 20 - A (" << std::format("{:10.4f}", D20P1.second.count()) << "ms): " << D20P1.first << "\n";
    auto D20P2 = AoC2022::Day20::B(AoC::Helpers::ReadLines("./Day20.txt"));
